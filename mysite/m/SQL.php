<?php
	...
	class SQL {
		...
		/*public function SelectTwo($table, $table2, $where_key = false, $where_key2 = false, $where_value = false, $where_value2 = false, $fetchAll = false) {
			
			if ($where_key2 AND $where_value) {
				$query = "SELECT * FROM " . $table . " WHERE " . $where_key . " = '" . $where_value . "'";
			} else {
				$query = "SELECT * FROM " . $table;
			}
